...
const VARIANT_STYLES = {
  ...
  "hero-dates": "font-open-sans text-center mb-12 text-3xl font-extrabold text-gray-200 md:text-4xl",
...
export const Text = ({ variant, children, align, underline, color }: TextProps) => {
